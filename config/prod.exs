...
# Envtest.Web.Endpoint.load_from_system_env/1 dynamically.
...
config :envtest, Envtest.Web.Endpoint,
  # on_init: {Envtest.Web.Endpoint, :load_from_system_env, []},
...
# start per endpoint:
#
#     config :envtest, Envtest.Web.Endpoint, server: true
#
